...
export const listMembers = async (userId, teamId) => {
...
export const addMember = async (userId, teamId, targetUserId, role = "MEMBER") => {
  ...
  return listMembers(userId, teamId);
};

export const removeMember = async (userId, teamId, targetUserId) => {
  await assertTeamAdmin(userId, teamId);
...
export const updateRole = async (userId, teamId, targetUserId, role) => {
  await assertTeamAdmin(userId, teamId);
...
export const requestToJoin = async (userId, teamId) => {
  const team = await prisma.team.findUnique({ where: { id: teamId } });
...
export const listRequests = async (userId, teamId) => {
  await assertTeamAdmin(userId, teamId);
...
export const respondToRequest = async (userId, requestId, accept) => {
...
export const myRequestStatus = async (userId, teamId) => {
